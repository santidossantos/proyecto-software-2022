                        ...
                        <div class="row m-l-0 m-r-0">
                            <div class="col-sm-4 bg-c-lite-green user-profile">
                                <div class="card-block text-center text-white">
                                    <div class="m-b-25">
                                        <img src="" class="rounded-circle border border-dark border-1" width="90"
                                            height="90" id="img">
                                    </div>
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <h6 class="text-muted f-w-400">Al día</h6>
                                            <p class="m-b-10 f-w-600">Fecha Alta</p>
                                            <h6 class="text-muted f-w-400">{{ associated.create_at }}
                                            </h6>
                                        </div>

                                        <div class="col-sm-6 mt-3">

                                            <qrcode-vue :value="QRValue" :size="size" level="H" style="float: right;" />
                                        </div>
                                    </div>
